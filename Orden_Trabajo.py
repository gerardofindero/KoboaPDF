...
def Ordendetrabajo(Cliente):

    print("Creando hoja de la orden de trabajo....")
    ...
    Fugas = pd.DataFrame(columns=['Equipo al cual se le colocara el timer', 'Ubicacion Exacta', 'Fuga', 'Ubicacion Exacta',
                                  'kWh en Recibo', 'Pesos en Recibo', 'Uso actual', 'Acción considerada',
