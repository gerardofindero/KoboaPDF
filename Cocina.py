    ...
    for i in ERquipos:
        if i == 1:
            ...
            if indx == 2:
                ...
                Aparatos_C.loc['Otro', 'CodigoN'] = Circuito.filter(regex='cocina_electrodomesticos_gasto_c_i')[0]
            ...
            if indx == 4:
                ...
                Aparatos_C.loc['Licuadora', 'CodigoN'] = Circuito.filter(regex='cocina_electrodomesticos_gasto_c_i')[0]
